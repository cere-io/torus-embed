...
export const getTorusUrl = async (
  ...
  switch (buildEnv) {
    ...
    case "binance":
      torusUrl = `https://binance.web3auth.io/v${versionUsed}`;
      logLevel = "info";
      break;
    case "testing":
      torusUrl = "https://testing.web3auth.io";
      logLevel = "debug";
      break;
    case "bnb":
      torusUrl = "https://bnb.web3auth.io";
      logLevel = "error";
      break;
    case "polygon":
      torusUrl = "https://polygon.web3auth.io";
      logLevel = "error";
      break;
    case "lrc":
      torusUrl = "https://lrc.web3auth.io";
      logLevel = "debug";
      break;
    case "beta":
      torusUrl = "https://beta.web3auth.io";
      logLevel = "debug";
      break;
    case "development":
